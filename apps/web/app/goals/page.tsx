  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-[var(--primary)] text-white px-6 pt-12 pb-10">
        ...
        <h1 className="text-2xl font-extrabold">{t('goals.whatIsYourGoal')}</h1>
        <p className="text-white/80 text-sm mt-2">{t('goals.suitedToYourGoal')}</p>
      </div>
      ...
      <div className="p-5 bg-white border-t border-gray-100">
        ...
        >
          <span>{t('goals.chooseInvestmentPlan')}</span>
          <span>→</span>
        </button>
      </div>
    </div>
