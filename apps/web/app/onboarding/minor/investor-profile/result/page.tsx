  ...
  return (
    <div className={'flex flex-col min-h-full bg-[#fafafa] transition-opacity duration-[1000ms] ' + (animateIn ? 'opacity-100' : 'opacity-0')}>
      ...
      <div className="px-6 py-8">
        <h3 className="text-xs font-bold text-gray-400 tracking-[0.2em] mb-6 uppercase">{t('minor.profileDna')}</h3>
      ...
      <div className="px-6 py-8 bg-white my-4 border-y border-gray-100">
        ...
        <div className="flex justify-between text-[10px] font-bold text-gray-400 tracking-wider">
          <span>{t('minor.calmer')}</span>
          <span>{t('minor.moreFluctuation')}</span>
        </div>
      ...
      <div className="px-6 py-8">
        <h3 className="text-xs font-bold text-gray-400 tracking-[0.2em] mb-6 uppercase">{t('minor.whatAnswersTell')}</h3>
      ...
      <div className="px-6 py-4">
        ...
        >
          <span className="font-bold text-[var(--primary)] text-sm">{t('minor.whyThisProfile')}</span>
      ...
      <div className="px-6 py-10 bg-white mt-4 border-t border-gray-100">
        ...
        <div className="relative border-l-2 border-blue-50 ml-3 space-y-8 pb-8">
          ...
          <div className="relative pl-6">
            ...
            <h4 className="font-bold text-[var(--dark)] text-sm mb-1">{t('minor.defineGoal')}</h4>
